...
URL = "https://lhowwphqgysisscfhfoe.supabase.co"
KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imxob3d3cGhxZ3lzaXNzY2ZoZm9lIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODM0OTI4MDksImV4cCI6MjA5OTA2ODgwOX0.f02QF23yLaWDP3VWUlLFoKMlZSDmmjHxMrdhGR6LdL8"
...
print("Inserting constituencies...")
res = requests.post(f"{URL}/rest/v1/constituencies", headers=headers, json=constituencies)
if res.status_code not in (200, 201):
    print("Error:", res.text)
    sys.exit(1)

print("Inserting wards...")
res = requests.post(f"{URL}/rest/v1/wards", headers=headers, json=wards)
if res.status_code not in (200, 201):
    print("Error:", res.text)
    sys.exit(1)
